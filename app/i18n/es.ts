...
const es: Translations = {
  ...
  signUpScreen: {
    signUp: "Registrarse",
    enterDetails: "Crea tu cuenta para comenzar. Mantendremos tu información segura.",
    emailFieldLabel: "Email",
    passwordFieldLabel: "Contraseña",
    confirmPasswordFieldLabel: "Confirmar Contraseña",
    emailFieldPlaceholder: "Ingresa tu email",
    passwordFieldPlaceholder: "Crea una contraseña fuerte",
  ...
  forgotPasswordScreen: {
    ...
    enterDetails: "Ingresa tu email y te enviaremos un enlace para restablecer tu contraseña.",
    emailFieldLabel: "Email",
    emailFieldPlaceholder: "Ingresa tu email",
    tapToResetPassword: "Enviar Enlace de Restablecimiento",
    resettingPassword: "Enviando...",
    successMessage: "¡Enlace de restablecimiento enviado! Revisa tu email.",
